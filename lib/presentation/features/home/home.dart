                ...
                Row(
                  ...
                  children: [
                    ...
                    const Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        TextView(text: 'Good morning 👋',color: AppColors.kDarkGreen,),
                        TextView(text: 'Jane Doe',color: AppColors.kDarkGreen,fontWeight: FontWeight.w700,fontSize: 24,),
                      ],
                    ),
                    const Spacer(),
                    GestureDetector(
                      ...
                      child: CircleAvatar(
                        ...
                        child: const Icon(Icons.notifications_rounded,color: AppColors.kDarkGreen,),
                      ),
                    ),
                  ],
                ),
            ...
            CustomTextField(
              ...
              trailing:  Padding(
                ...
                child: CircleAvatar(
                  ...
                  child: SvgPicture.asset(AppAssets.scanIcon,height:23,width: 23,),
                ),
              ),
              ...
              fillColor: AppColors.kWhite.withOpacity(0.10),
                ...
                GestureDetector(
                  onTap: provider.fetchDeliveries,
                    child: const TextView(text: 'Enter parcel number or scan QR code',fontSize: 14,fontWeight: FontWeight.w300,color: AppColors.kDarkGreen,)),
...
class _ShowBottomSheetState extends State<ShowBottomSheet> {
  @override
  Widget build(BuildContext context) {
    return TextView(text: 'SHOW SHEETS',onTap: (){
      showModalBottomSheet(context: context, builder: (BuildContext context){
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
               const TextView(text: 'Results for “NB145618X8S”', fontSize: 20, fontWeight: FontWeight.w700,),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: AppColors.kBlack.withOpacity(0.2), // Shadow color with transparency
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child:  Image.asset(AppAssets.parcelImg,fit: BoxFit.contain,),
                    ),
                    const SizedBox(width: 10),
                     Column(
                      ...
                      children: [
                        const TextView(text: 'NB145618X8S', fontWeight: FontWeight.bold,color: AppColors.kDarkGreen),
                    ...
                    Container(
                      ...
                      child: const TextView(text: 'In Transit',fontSize: 13,fontWeight: FontWeight.w600,color: AppColors.kPrimary),
                    )
                  ],
                ),
              ),
              const Gap(40),
               ...
               CustomAppButton(title: 'Details Live',
                 voidCallback: (){
                 ...
                 btnIcon: SvgPicture.asset(AppAssets.trailIcon,color: AppColors.kBlack,),)
            ],
          ),
        ));
      });
